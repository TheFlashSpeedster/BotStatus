...
start_text = "🤖 𝗔𝗖𝗘 - 𝗕𝗼𝘁 𝗦𝘁𝗮𝘁𝘂𝘀 📊\n" # default for start_message.
start_message = os.getenv('START_MESSAGE', start_text) # text before the status to show.
end_text = "**🔄 Bot Status are Updated Every 3 hours Automatically!**" # default for end_message.
...
time_format = os.getenv('TIME_FORMAT', '%I:%M %p | %d %b %Y') # Time format, defaults to Hrs:minutes Day/Month. Eg, 9:41 12/9
